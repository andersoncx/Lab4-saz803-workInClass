package edu.utsa.cs3443.saz803_lab4.model;
...
public class Trivia {
    ...
    //TODO: Write setters/getters for all the instance variables

    //loadTrivia: this method takes in an Activity from input as an argument,
    //it reads the file and stores 1 piece of trivia from that file
    ...
    public Trivia loadTrivia(Activity activity) {
        ...
        //How many lines are in this file, number of lines are equivalent to the number of trivia questions
        //Randomly select a number smaller or equal to the number of lines
        ...
        Scanner scanner;
        try {
            InputStream input = manager.open( fileName: "trivia.csv" );
            ...
            line = scanner.nextLine();
            String[] lineSplit = line.trim().split( regex: ",");
